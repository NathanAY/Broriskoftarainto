...
func _ready():
    ...
    #$ItemHolder.add_item(load("res://src/Resources/items/ChainProjectile.tres"))
    #$ItemHolder.add_item(load("res://src/Resources/items/BounceProjectile.tres"))
    #$ItemHolder.add_item(load("res://src/Resources/items/LifeOnKill.tres"))
    ...
    #$ItemHolder.add_item(load("res://src/Resources/items/ExplosiveShot.tres"))
    ...
    #$ItemHolder.add_item(load("res://src/Resources/items/PoisonHit.tres"))
